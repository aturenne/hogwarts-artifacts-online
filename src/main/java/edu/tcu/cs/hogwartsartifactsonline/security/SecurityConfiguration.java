...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilerChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests
                        .requestMatchers(HttpMethod.GET, this.baseUrl + "/artifacts/**").permitAll() //if url starts with this, no authorization needed
    ...
    public PasswordEncoder passwordEncoder() {
        return new BCryptPasswordEncoder(12); //2^12 hashing iterations
    }
